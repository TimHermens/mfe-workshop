...
exports.getTsSourceFile =
  exports.getDecoratorPropertyValueNode =
  exports.readBootstrapInfo =
  exports.addEntryComponents =
  exports.addDeclarationToModule =
  exports.addProviderToModule =
  exports.addRoute =
  exports.getBootstrapComponent =
  exports.replaceIntoToTestBed =
  exports.addDeclarationsToTestBed =
  exports.addImportToTestBed =
  exports.addImportToModule =
  exports.removeFromNgModule =
  exports.getDecoratorMetadata =
    void 0;
...
function getDecoratorMetadata(source, identifier, module) {
  const angularImports = (0, find_nodes_1.findNodes)(
    source,
...
function _addSymbolToNgModuleMetadata(
  ...
  if (matchingProperties.length == 0) {
    ...
    return (0, ast_utils_1.insertChange)(
      host,
      source,
      ngModulePath,
      position,
...
function removeFromNgModule(host, source, modulePath, property) {
  ...
  if (matchingProperty) {
    return (0, ast_utils_1.removeChange)(
      host,
      source,
      modulePath,
...
function addImportToTestBed(host, source, specPath, symbolName) {
  const allCalls = (0, find_nodes_1.findNodes)(
    source,
  ...
  const configureTestingModuleObjectLiterals = allCalls
    ...
    .filter(
      (c) => c.expression.name.getText(source) === 'configureTestingModule'
    )
    .map((c) =>
...
function replaceIntoToTestBed(
  ...
  if (configureTestingModuleObjectLiterals.length > 0) {
    const startPosition = configureTestingModuleObjectLiterals[0]
      .getFirstToken(source)
      .getEnd();
    return (0, ast_utils_1.replaceChange)(
      host,
      source,
      specPath,
      startPosition,
...
function getListOfRoutes(source) {
  const imports = getMatchingProperty(
    source,
    'imports',
    'NgModule',
    '@angular/core'
      ...
      if (e.kind === ts.SyntaxKind.CallExpression) {
        ...
        if (
          ...
          if (routes.kind === ts.SyntaxKind.ArrayLiteralExpression) {
            ...
            const variableDeclarations = (0, find_nodes_1.findNodes)(
              source,
...
function readBootstrapInfo(host, app) {
  ...
  const moduleImports = (0, ast_utils_1.getImport)(
    main,
    (s) => s.indexOf('.module') > -1
  );
...
function getDecoratorPropertyValueNode(
  host,
  modulePath,
  identifier,
  property,
